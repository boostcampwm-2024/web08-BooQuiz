import{j as e}from"./jsx-runtime-DR9Q75dM.js";import"./index-DRjF_FHU.js";const t=({type:a="text",label:r,value:n,onChange:c,name:s,placeholder:v,disabled:D=!1,error:h=!1,isUnderline:M=!1,onKeyDown:H,...O})=>e.jsxs("div",{className:"input-wrapper",children:[e.jsx("label",{htmlFor:s,children:r}),e.jsx("input",{autoFocus:!0,type:a,id:s,name:s,value:n,onChange:c,placeholder:v,disabled:D,className:`${h?"error":""} focus:outline-none w-full`,onKeyDown:H,...O}),h&&e.jsx("span",{className:"error-message",children:h}),M&&e.jsx("div",{className:"underline h-[2px] w-full bg-blue-600"})]});t.__docgenInfo={description:`@description
...
}`,...(V=(T=d.parameters)==null?void 0:T.docs)==null?void 0:V.source}}};var N,S,U;i.parameters={...i.parameters,docs:{...(N=i.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: () => {
    return <div className="w-[300px]">
                <Input label="비활성화" name="disabled" value="수정할 수 없는 필드입니다" onChange={() => {}} disabled />
            </div>;
  }
}`,...(U=(S=i.parameters)==null?void 0:S.docs)==null?void 0:U.source}}};var _,q,L;m.parameters={...m.parameters,docs:{...(_=m.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => {
...
}`,...(L=(q=m.parameters)==null?void 0:q.docs)==null?void 0:L.source}}};const F=["Default","WithLabel","WithError","WithUnderline","Disabled","DifferentTypes"];export{o as Default,m as DifferentTypes,i as Disabled,u as WithError,p as WithLabel,d as WithUnderline,F as __namedExportsOrder,K as default};
