 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mo=L("TriangleAlert",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3",key:"wmoenq"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]),po=e=>{switch(e){case"success":return l.jsx(co,{className:"h-6 w-6 text-[#22c55e]"});case"warning":return l.jsx(mo,{className:"h-6 w-6 text-[#eab308]"});case"error":return l.jsx(fn,{className:"h-6 w-6 text-[#ef4444]"});default:return l.jsx(Oe,{className:"h-6 w-6 text-[#2563eb]"})}},vo=e=>{switch(e){case"success":return"border-[#22c55e]/20 ";case"warning":return"border-[#eab308]/20";case"error":return"border-[#ef4444]/20 ";default:return"border-[#2563eb]/20 "}},mn=({trigger:e,alert:t,onConfirm:n,onCancel:r})=>{const o=()=>{r==null||r()},a=()=>{n()};return l.jsxs(ao,{children:[l.jsx(io,{asChild:!0,children:l.jsxs(xn,{variant:e.variant,size:e.size,disabled:e.disabled,children:[e.icon&&l.jsx("span",{className:"mr-2",children:e.icon}),e.text]})}),l.jsxs(Ne,{className:` border-2 ${vo(t.type??"info")}`,children:[l.jsxs(Ae,{className:"gap-4",children:[l.jsxs("div",{className:"flex items-center gap-2",children:[po(t.type??"info"),l.jsx(De,{children:t.title})]}),t.description&&l.jsx(Te,{children:t.description})]}),l.jsxs(Se,{children:[l.jsx(Pe,{onClick:o,children:t.cancelText??"취소"}),l.jsx(Re,{onClick:a,children:t.confirmText??"확인"})]})]})]})};mn.__docgenInfo={description:`@description
