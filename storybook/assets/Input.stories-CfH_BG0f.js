import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{r as Y}from"./index-DRjF_FHU.js";import{T as G}from"./Typogrpahy-DnsS6UIb.js";const t=Y.forwardRef(({type:n="text",label:r,value:a,onChange:c,name:s,placeholder:h,disabled:H=!1,error:g=!1,isUnderline:W=!1,onKeyDown:K,isAutoFocus:$=!1,className:x,isBorder:z=!1,step:O,min:A,max:B,isShowCount:P,height:f="h-8",...k},J)=>{const b=()=>({"h-6":"text-xs","h-8":"text-sm","h-10":"text-base","h-12":"text-lg","h-14":"text-xl","h-16":"text-2xl"})[f]||"text-base",X=x?`input-wrapper  ${x}`:"input-wrapper",v=b();return e.jsxs("div",{className:X,children:[e.jsxs("div",{className:"w-full flex flex-row justify-between",children:[r&&e.jsx("label",{htmlFor:s,className:v,children:r}),g&&e.jsx("span",{className:`error-message ${v} text-red-500 text-[10px]`,children:g})]}),e.jsx("input",{ref:J,autoFocus:$,type:n,id:s,name:s,value:a,onChange:c,placeholder:h,disabled:H,className:`
                        ${g?"error":""} 
                        focus:outline-none 
                        w-full 
                        ${z?"border border-gray-300":""} 
                        rounded-lg
                        p-2
                        ${f}
                        ${v}
                        leading-normal
                    `,onKeyDown:K,step:O,min:A,max:B,...k}),W&&e.jsx("div",{className:"underline h-[2px] w-full bg-blue-600"}),typeof a=="string"&&P&&e.jsx("div",{className:"w-full text-right pr-1",children:e.jsx(G,{text:a.length.toString()+"자",color:"gray",size:b().replace("text-","")})})]})});t.displayName="Input";t.__docgenInfo={description:`\`Input\` 컴포넌트는 다양한 입력 필드를 렌더링합니다.
...
}`,...(C=(w=o.parameters)==null?void 0:w.docs)==null?void 0:C.source}}};var T,j,I;u.parameters={...u.parameters,docs:{...(T=u.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: () => {
    const [value, setValue] = useState('');
    return <div className="w-[300px]">
...
}`,...(I=(j=u.parameters)==null?void 0:j.docs)==null?void 0:I.source}}};var E,V,N;i.parameters={...i.parameters,docs:{...(E=i.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => {
    const [value, setValue] = useState('');
    return <div className="w-[300px]">
...
}`,...(N=(V=i.parameters)==null?void 0:V.docs)==null?void 0:N.source}}};var S,q,_;p.parameters={...p.parameters,docs:{...(S=p.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => {
    const [value, setValue] = useState('');
    return <div className="w-[300px]">
...
}`,...(_=(q=p.parameters)==null?void 0:q.docs)==null?void 0:_.source}}};var L,U,D;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => {
    return <div className="w-[300px]">
                <Input label="비활성화" name="disabled" value="수정할 수 없는 필드입니다" onChange={() => {}} disabled />
            </div>;
  }
}`,...(D=(U=d.parameters)==null?void 0:U.docs)==null?void 0:D.source}}};var F,M,R;m.parameters={...m.parameters,docs:{...(F=m.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: () => {
...
}`,...(R=(M=m.parameters)==null?void 0:M.docs)==null?void 0:R.source}}};const re=["Default","WithLabel","WithError","WithUnderline","Disabled","DifferentTypes"];export{o as Default,m as DifferentTypes,d as Disabled,i as WithError,u as WithLabel,p as WithUnderline,re as __namedExportsOrder,ne as default};
