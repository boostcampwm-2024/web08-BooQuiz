import{j as e}from"./jsx-runtime-DR9Q75dM.js";import{r as Y}from"./index-DRjF_FHU.js";import{T as G}from"./Typogrpahy-DnsS6UIb.js";const t=Y.forwardRef(({type:n="text",label:r,value:a,onChange:c,name:s,placeholder:h,disabled:H=!1,error:g=!1,isUnderline:W=!1,onKeyDown:K,isAutoFocus:$=!1,className:x,isBorder:z=!1,step:O,min:A,max:B,isShowCount:P,height:f="h-8",...k},J)=>{const b=()=>({"h-6":"text-xs","h-8":"text-sm","h-10":"text-base","h-12":"text-lg","h-14":"text-xl","h-16":"text-2xl"})[f]||"text-base",X=x?`input-wrapper ${x}`:"input-wrapper",v=b();return e.jsxs("div",{className:X,children:[r&&e.jsx("label",{htmlFor:s,className:v,children:r}),e.jsx("input",{ref:J,autoFocus:$,type:n,id:s,name:s,value:a,onChange:c,placeholder:h,disabled:H,className:`
                        ${g?"error":""} 
                        focus:outline-none 
                        w-full 
                        ...
                        ${v}
                        leading-normal
                    `,onKeyDown:K,step:O,min:A,max:B,...k}),g&&e.jsx("span",{className:`error-message ${v}`,children:g}),W&&e.jsx("div",{className:"underline h-[2px] w-full bg-blue-600"}),typeof a=="string"&&P&&e.jsx("div",{className:"w-full text-right pr-1",children:e.jsx(G,{text:a.length.toString()+"자",color:"gray",size:b().replace("text-","")})})]})});t.displayName="Input";t.__docgenInfo={description:`\`Input\` 컴포넌트는 다양한 입력 필드를 렌더링합니다.
